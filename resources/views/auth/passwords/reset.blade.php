...
<div class="row">
    <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
        ...
        <div class="card card-shadowed mt-25 px-50 py-30 w-400px mx-auto" style="max-width: 100%">
            ...
            <div class="card-body">
                <form id="reset-form" method="POST" action="{{URL::to('user/password-reset')}}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email', isset($email) ? $email : null) }}" required autofocus>
                        ...
                        <div class="form-group col-md-12">
                            <label for="password">{{ Lang::get('Nueva contraseña') }}</label>
                        ...
                        <div class="form-group col-md-12">
                            <label for="confirm_password">{{ Lang::get('Confirmar nueva contraseña') }}</label>
