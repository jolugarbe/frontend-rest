...
@section('breadcrumb')
    <ol class="breadcrumb d-none d-md-block">
        <li class="breadcrumb-item active" style="display: inline"><a href="{{URL::to('admin/profile')}}">Mi Perfil</a></li>
        ...
        <div class="col-xl-8 offset-xl-2">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs nav-justified">
                    <li class="nav-item">
                        <a class="nav-link active show" data-toggle="tab" href="#profile-basic">Mi perfil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#password-basic">Contraseña</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="profile-basic">
                        <form id="update-form" method="POST" action="{{URL::to('admin/profile/update')}}">
                            @csrf

                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="text-light fw-400">Datos del Administrador</h5>
                                </div>
                    ...
                    <div class="tab-pane fade" id="password-basic">
                        <form id="password-form" method="POST" action="{{URL::to('user/password/update')}}">
                            @csrf

                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="text-light fw-400">Modificar Contraseña</h5>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="confirm_password">{{ Lang::get('Confirmar contraseña') }}</label>
                                    <input id="confirm_password" type="password" class="form-control{{ $errors->has('confirm_password') ? ' is-invalid' : '' }}" name="confirm_password" value="{{ old('confirm_password') }}" required>
