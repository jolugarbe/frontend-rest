    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <header class="card-header">
                <h4 class="card-title">{{__('Empresa cedente')}}</h4>
                    ...
                    <form>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="carbon_inscription" type="text" class="form-control{{ $errors->has('carbon_inscription') ? ' is-invalid' : '' }}" name="carbon_inscription" value="{{ old('carbon_inscription', isset($owner_user) ? $owner_user['carbon_inscription'] ? \Carbon\Carbon::createFromFormat('Y-m-d',$owner_user['carbon_inscription'])->format('d/m/Y') : "" : null) }}" required readonly="readonly">
